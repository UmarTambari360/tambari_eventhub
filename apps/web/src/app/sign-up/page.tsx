...
export default function SignUpPage() {
  ...
  const getPasswordStrength = (pwd: string) => {
    ...
    const strengths = [
      { score: 0, label: 'Weak', color: 'text-danger' },
      { score: 1, label: 'Weak', color: 'text-danger' },
      { score: 2, label: 'Fair', color: 'text-warning' },
      { score: 3, label: 'Good', color: 'text-warning' },
      { score: 4, label: 'Strong', color: 'text-success' },
      { score: 5, label: 'Very Strong', color: 'text-success' },
    ];
                      ...
                      {password && strength && (
                        <div className="mt-2 space-y-1.5">
                          <div className="flex items-center justify-between">
                            ...
                            <span
                              className={`text-xs font-medium ${strength.color} whitespace-nowrap`}
                            >
                              {strength.label}
                            </span>
                          </div>
                          ...
                          <div className="grid grid-cols-2 gap-1 mt-1.5">
                            {[
                              ...
                              <div key={req.label} className="flex items-center gap-1.5 text-xs">
                                ...
                                <span
                                  className={req.check ? 'text-text-secondary' : 'text-text-muted'}
                                >
                                  {req.label}
                                </span>
                              </div>
